...
public class MRPastRecordsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dayViewFlag = true;
		tvYearTitle = (TextView) this
				.findViewById(R.id.pastRecord_activity_tv_year_title);

		tvMonthTitle = (TextView) this
				.findViewById(R.id.pastRecord_activity_tv_month_title);

		tvAvgScore = (TextView) this
				.findViewById(R.id.past_record_activity_avg_score);

		llProgress1 = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_progress1);
		rlProgress1 = (RelativeLayout) this
				.findViewById(R.id.past_record_activity_rl_progress1);
		tvProgressTime1 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_time1);
		tvProgressScore1 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_score1);

		llProgress2 = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_progress2);
		rlProgress2 = (RelativeLayout) this
				.findViewById(R.id.past_record_activity_rl_progress2);
		tvProgressTime2 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_time2);
		tvProgressScore2 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_score2);

		llProgress3 = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_progress3);
		rlProgress3 = (RelativeLayout) this
				.findViewById(R.id.past_record_activity_rl_progress3);
		tvProgressTime3 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_time3);
		tvProgressScore3 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_score3);

		llProgress4 = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_progress4);
		rlProgress4 = (RelativeLayout) this
				.findViewById(R.id.past_record_activity_rl_progress4);
		tvProgressTime4 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_time4);
		tvProgressScore4 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_score4);

		llProgress5 = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_progress5);
		rlProgress5 = (RelativeLayout) this
				.findViewById(R.id.past_record_activity_rl_progress5);
		tvProgressTime5 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_time5);
		tvProgressScore5 = (TextView) this
				.findViewById(R.id.past_record_activity_tv_progress_score5);

		lcv = (LineCharView) findViewById(R.id.past_records_activity_lcv);

		llDayView = (LinearLayout) this
				.findViewById(R.id.past_records_activity_ll_day_view);

		llWeekView = (LinearLayout) this
				.findViewById(R.id.past_records_activity_ll_week_view);
		...
		tabHead = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_day_tab_head);
		...
		tabFace = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_day_tab_face);
		...
		tabNose = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_day_tab_nose);
		...
		tabChin = (LinearLayout) this
				.findViewById(R.id.past_record_activity_ll_day_tab_chin);
		...
		// 日历控件
		prDp = (DatePicker) this
				.findViewById(R.id.pastRecord_activity_DatePicker);
		...
		btnViewSelect = (Button) this
				.findViewById(R.id.past_record_activity_btn_view_select);
	 ...
	 * 重置周视图的展示数据
	 */
	private void resetWeekView(String date) {
		try {
	...
	private void showDayHistory(String date, int partType) {
		...
		if (date != null) {
			try {
				...
				// 今天的数据
				List<TestModel> list = MRTestBLL.getTestListByTime(partType,
						MRPastRecordsActivity.this, startTime, endTime);
				int avgScore = MRTestBLL.getTestAverage(partType, startTime,
						endTime, MRPastRecordsActivity.this);
				if (!list.isEmpty()) {
		...
		if (date != null) {
			...
			try {
				...
				for (int i = 0; i < 7; i++) {
					...
					j--;
					int value = MRTestBLL.getTestMax(partType, startTime,
							endTime, MRPastRecordsActivity.this);
