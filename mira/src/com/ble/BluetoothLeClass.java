...
public class BluetoothLeClass {
	...
	private BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
		...
		public void onLeScan(final BluetoothDevice device, int rssi,
			...
			Log.i(TAG, "mLeScanCallback.onLeScan() deviceName: " + deviceName);
			...
			if (deviceName != null && deviceName.equals(DeviceName)) {
				...
				Log.i(TAG, "mLeScanCallback.onLeScan() bluetoothAddress: " + bluetoothAddress);
				boolean bRet = connect(bluetoothAddress);
				Log.i(TAG, "mLeScanCallback.onLeScan() bRet = " + bRet);
				//连接失败，继续扫描
				if(!bRet){
					mScanning = true;
					mBluetoothAdapter.startLeScan(mLeScanCallback);
			...
			// rssi
			Log.i(TAG, "mLeScanCallback.onLeScan() rssi = " + rssi);
			Log.i(TAG, "mLeScanCallback.onLeScan() mac = " + bluetoothAddress);
			Log.i(TAG, "mLeScanCallback.onLeScan() scanRecord.length = " + scanRecord.length);
		}
	};
}
